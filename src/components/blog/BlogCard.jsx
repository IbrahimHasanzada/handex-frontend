...
const BlogCard = ({ item }) => {
    ...
    return (
        <div className='rounded-2xl box-shadow bg-white py-5 px-3'>
            ...
            <div className='w-full h-[232px] rounded-[12px] mt-4 relative'>
                <Image className='w-full h-full object-cover rounded-[12px]' src={item.image.url} alt={item.title || 'News card image'} width={100} height={100} />
                <div className='absolute bg-white top-0 right-0 pb-2 pl-2 border-b-l-5'>
                    <button onClick={() => handleClick()} className='flex cursor-pointer items-center rounded-[20px] border border-primary-corporate'>
