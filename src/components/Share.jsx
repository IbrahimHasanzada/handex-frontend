    ...
    return (
        <div className='w-max rounded-[48px] flex gap-4 items-center justify-center bg-white py-2 px-6'>
            ...
            <div className='flex gap-2'>
                <WhatsappShareButton id='whatsaap-share' url={shareUrl}>
                    <div className='size-10 cursor-pointer rounded-full bg-[#E8E8E8] flex justify-center items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd" d="M18.7041 5.76205C17.0581 4.11505 14.8691 3.20705 12.5371 3.20605C7.73014 3.20605 3.81914 7.11505 3.81814 11.9201C3.81614 13.4491 4.21714 14.9521 4.98114 16.2771L3.74414 20.7931L8.36614 19.5811C9.64514 20.2771 11.0771 20.6421 12.5331 20.6421H12.5371C17.3421 20.6421 21.2531 16.7321 21.2551 11.9271C21.2561 9.59905 20.3501 7.41005 18.7041 5.76205Z" stroke="#141414" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <FacebookShareButton id='facebook-share' url={shareUrl}>
                    <div className='size-10 cursor-pointer rounded-full bg-[#E8E8E8] flex justify-center items-center'>
                ...
                <LinkedinShareButton id='linkedin-share' url={shareUrl}>
                    <div className='size-10 cursor-pointer rounded-full bg-[#E8E8E8] flex justify-center items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                ...
                <TelegramShareButton id='telegram-share' url={shareUrl}>
                    <div className='size-10 cursor-pointer rounded-full bg-[#E8E8E8] flex justify-center items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
