      ...
      <div className={`${theme ? 'bg-[#2b2b2b]' : 'bg-white border border-[#DDD]'} box-shadow rounded-[20px] overflow-hidden`}>
        <div className='flex flex-col md:flex-row justify-between gap-11 px-6 py-6 md:py-13'>
          <div className='md:w-1/4 flex flex-col items-center md:items-baseline pb-7 md:pb-0'>
            <Image src='/assets/img/handex_logo.png' alt='Handex Logo' quality={100} sizes='100%' width={128} height={40} className='w-32 h-10 select-none' />
          ...
          <div className=' flex flex-col justify-between md:w-2/3'>
            <div className='flex justify-between md:justify-baseline pb-12'>
              <div className='md:order-3'>
                <h2 className='text-[#909090] text-xs font-medium md:font-bold md:border-b border-b-[#DDD] md:pb-4'>{title[2]}</h2>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-0 md:flex-row md:flex-2/4'>
                <div className='md:order-1'>
                  <h2 className='text-[#909090] text-xs font-medium md:font-bold md:border-b border-b-[#DDD] md:pb-4'>{title[1]}</h2>
                  <ul className='flex flex-col gap-1 pt-5 md:pt-8'>
                    {about.map((item: { text: string, link: string; }, index: number) => (
                      <li className={`text-sm md:text-base ${theme ? 'text-white' : 'text-black'}`} key={index}>
                ...
                <div>
                  <h2 className='text-[#909090] text-xs font-medium md:font-bold md:border-b border-b-[#DDD] md:pb-4'>{title[0]}</h2>
                  <ul className='flex flex-col gap-1 pt-5 md:pt-8'>
              ...
              <div className=''>
                <div className='flex gap-11'>
                  <div>
                    ...
                    <p className={`text-sm md:text-base ${theme ? 'text-white' : 'text-black'}`}>{general[0]?.phone[0]}</p>
                  </div>
                  <div>
                    <p className='text-[#909090] text-xs font-bold'>{t('footer.mail')}</p>
                    <p className={`text-sm md:text-base ${theme ? 'text-white' : 'text-black'}`}>{general[0]?.email}</p>
                  </div>
                </div>
                <div className='pt-4'>
                  <p className='text-[#909090] text-xs font-bold'>{t('footer.location')}</p>
                  <p className={`text-sm md:text-base ${theme ? 'text-white' : 'text-black'}`}>{general[0]?.location}</p>
                </div>
              </div>
              <div className='flex justify-end items-end gap-2 lg:mt-0 mt-6'>
                <Link href='https://www.instagram.com/handex.edu.az/' target='_blank' className='size-10 rounded-full bg-[#E8E8E8] flex justify-center items-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <path d="M16.9492 6.71279C16.7632 6.71379 16.6122 6.86479 16.6122 7.05079C16.6122 7.23679 16.7642 7.38779 16.9502 7.38779C17.1362 7.38779 17.2872 7.23679 17.2872 7.05079C17.2882 6.86379 17.1362 6.71279 16.9492 6.71279" stroke="#141414" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M14.5455 9.45432C15.9514 10.8602 15.9514 13.1396 14.5455 14.5455C13.1396 15.9514 10.8602 15.9514 9.45432 14.5455C8.04843 13.1396 8.04843 10.8602 9.45432 9.45432C10.8602 8.04843 13.1396 8.04843 14.5455 9.45432" stroke="#141414" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </Link>
                <Link href='https://www.facebook.com/handex.edu' target='_blank' className='size-10 rounded-full bg-[#E8E8E8] flex justify-center items-center'>
                ...
                <Link href='https://www.linkedin.com/company/handexeduaz/' target='_blank' className='size-10 rounded-full bg-[#E8E8E8] flex justify-center items-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <path d="M8.12012 11.1001V16.5001" stroke="#141414" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M11.7192 16.5001V13.3501C11.7192 12.1071 12.7262 11.1001 13.9692 11.1001V11.1001C15.2122 11.1001 16.2192 12.1071 16.2192 13.3501V16.5001" stroke="#141414" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <Link href='https://www.youtube.com/@HandexEdu' target='_blank' className='size-10 rounded-full bg-[#E8E8E8] flex justify-center items-center'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
