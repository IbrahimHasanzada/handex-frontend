...
const StudyCards: React.FC<StudyCardsDto> = ({ item, index }) => {
    return (
        <div className='group relative bg-white rounded-3xl w-full sm:h-65 sm:max-w-60 xl:h-76 xl:max-w-76 p-6 flex flex-col justify-between'>
            ...
            <div className='absolute -top-1 -right-5 md:-top-3 md:-right-8 xl:-top-5 xl:-right-7 bg-primary-bg w-17 h-17 md:w-25 md:h-25 xl:w-28 xl:h-28 p-2 md:p-3 xl:p-5 rounded-full flex items-center justify-center'>
