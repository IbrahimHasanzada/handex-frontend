...
const Top = ({ theme }: any) => {
    ...
    return (
        <div id='top' onClick={() => handleClick()} className={`${theme ? 'bg-[#e7e7e733]' : 'bg-[#E8E8E8]'} size-17 md:size-22 cursor-pointer rounded-full  ml-2 flex justify-center items-center`}>
