...
export async function generateMetadata({ params }) {
  ...
  const canonicalUrl = `${baseUrl}/layihe/${slug}`;
  ...
  return (
    <div className='wrapper pt-30'>
      <div className='w-full gap-6 mt-15 md:flex justify-between'>
        <p className='text-base text-primary-corporate md:hidden block'>Layihələrimiz</p>
        ...
        <div className='md:w-1/2'>
          <p className='text-base text-[#909090] md:block hidden'>Layihələrimiz</p>
