...
const page = async ({ params }: any) => {
    ...
    return (
        <div className='wrapper pt-40'>
            ...
            <h3 className={`${item.model === 'corporate' && 'text-white'} text-2xl md:text-[38px] font-bold text-center mt-30`}>Niyə Handex ?</h3>
            ...
            <div className='mt-6 md:mt-30'>
                <p className={`font-bold text-2xl md:text-4xl mb-6 ${item.model === 'corporate' && 'text-white'}`}>Tez-tez verilən suallar</p>
